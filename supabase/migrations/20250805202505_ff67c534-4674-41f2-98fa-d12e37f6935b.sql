-- Adicionar campo de data de vencimento aos tickets
ALTER TABLE public.tickets 
ADD COLUMN due_date TIMESTAMP WITH TIME ZONE;

-- Adicionar índice para consultas de tickets vencidos
CREATE INDEX idx_tickets_due_date ON public.tickets(due_date) WHERE due_date IS NOT NULL;
...
DROP TRIGGER IF EXISTS ticket_changes_trigger ON public.tickets;

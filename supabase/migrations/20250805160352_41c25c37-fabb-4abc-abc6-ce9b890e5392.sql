...
INSERT INTO public.notification_settings (event_type, is_enabled, recipients) VALUES
  ('ticket_created', true, ARRAY['admins', 'assignee']),
  ('ticket_assigned', true, ARRAY['assignee', 'submitter']),
  ('ticket_updated', true, ARRAY['assignee', 'submitter']),
  ('ticket_closed', true, ARRAY['submitter']),
  ('comment_added', true, ARRAY['assignee', 'submitter']);